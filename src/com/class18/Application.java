...
public class Application{
		...
		System.out.println("This is anim2" );
		        ...
		        System.out.println("This is anim3" );
		                ...
		                int my_array[] = { 5, 2, 3, 4, 5, 6, 7, 8, 9, 10 };
		               System.out.println("Printing minmum values");
		               System.out.println(Minimum.minOfValues(my_array));
		              
		               System.out.println("Printing max value");
		               int[] array = { 25, 14, 56, 15, 36, 56, 77, 18, 29, 49 };
		                System.out.println(Minimum.MaxandMin(array));
          
		                
		                Calculator sd=new Calculator();
		                sd.sum(10, 19, 25);
		                sd.min(50, 49, 46);
		                sd.maximum(808, 905, 949);
		                sd.average(100,200,300);
